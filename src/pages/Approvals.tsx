                                            ...
                                            <div className="space-y-2">
                                                ...
                                                {approval.type === 'timeoff' && (
                                                    <div className="text-sm space-y-1">
                                                        <p><strong>Dates:</strong> {approval.details.startDate} to {approval.details.endDate}</p>
                                                        <p><strong>Duration:</strong> {approval.details.days} days</p>
                                                        <p><strong>Reason:</strong> {approval.details.reason}</p>
                                                    </div>
                                                )}

                                                {approval.type === 'expense' && (
                                                    <div className="text-sm space-y-1">
                                                        <p><strong>Amount:</strong> ${approval.details.amount.toLocaleString()}</p>
                                                        <p><strong>Category:</strong> {approval.details.category}</p>
                                                        <p><strong>Description:</strong> {approval.details.description}</p>
                                                    </div>
                                                )}

                                                {approval.type === 'project' && (
                                                    <div className="text-sm space-y-1">
                                                        <p><strong>Project:</strong> {approval.details.projectName}</p>
                                                        <p><strong>Budget:</strong> ${approval.details.budget.toLocaleString()}</p>
                                                        <p><strong>Timeline:</strong> {approval.details.timeline}</p>
                                                        <p><strong>Resources Needed:</strong> {approval.details.resources} team members</p>
                                                    </div>
                                                )}

                                                {approval.type === 'access' && (
                                                    <div className="text-sm space-y-1">
                                                        <p><strong>System:</strong> {approval.details.system}</p>
                                                        <p><strong>Access Level:</strong> {approval.details.level}</p>
                                                        <p><strong>Justification:</strong> {approval.details.justification}</p>
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex items-center space-x-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-muted-foreground">
                                                    {approval.requestor.name} • Requested {format(new Date(approval.requestDate), 'MMM d, yyyy')}
                                                </p>
                                                {approval.reason && (
                    ...
                    {selectedApproval && (
                        <div className="space-y-4">
                            <div className="p-4 bg-muted rounded-lg">
                                ...
                                <p className="text-sm text-muted-foreground">
                                    Requested by {selectedApproval.requestor.name} on {format(new Date(selectedApproval.requestDate), 'MMM d, yyyy')}
                                </p>
                            </div>
                            <div>
