            ...
            <div className="space-y-2">
              ...
              <div className="flex space-x-2">
                <Input
                  ...
                  className="flex-1"
                />
                <Button onClick={discoverSSO} disabled={!domain || isLoading} size="sm">
            ...
            <div className="grid grid-cols-2 gap-3">
              {popularProviders.map(provider => (
                <Button
                  ...
                  disabled={isLoading}
                  className="flex h-12 items-center justify-start p-3"
                >
                  <span className="mr-3 text-lg">{provider.logo}</span>
