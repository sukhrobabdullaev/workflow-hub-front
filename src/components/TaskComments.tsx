    ...
    return (
      <div key={comment.id} className={`flex gap-3 ${isReply ? 'ml-12 mt-2' : ''}`}>
        <Avatar className="h-8 w-8 flex-shrink-0">
          ...
          <AvatarFallback className="text-xs">{getUserInitials(comment.userName)}</AvatarFallback>
        </Avatar>
    ...
    <div className={className}>
      <Card className="shadow-soft">
        ...
        <CardContent className="space-y-4">
          ...
          {/* Reply indicator */}
          {replyingTo && (
            <div className="flex items-center gap-2 rounded bg-muted/30 p-2 text-sm text-muted-foreground">
          ...
          <div className="space-y-2">
            <div className="relative">
              ...
              {showMentions && filteredMembers.length > 0 && (
                <div className="absolute z-10 mt-1 w-64 rounded-lg border bg-background shadow-lg">
                  <div className="border-b p-2 text-xs text-muted-foreground">Mention someone</div>
